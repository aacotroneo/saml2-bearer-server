...
$settingsInfo = array(
    ...
    'sp' => array(
        ...
        'x509cert'   => file_get_contents(__DIR__.'/../vendor/onelogin/php-saml/tests/data/customPath/certs/sp.crt'),
        'privateKey' => file_get_contents(__DIR__.'/../vendor/onelogin/php-saml/tests/data/customPath/certs/sp.key'),
    ),
